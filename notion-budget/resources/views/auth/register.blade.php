...
@section('content')
    ...
    <div class="mt-3 pt-3 border-top text-center">
        ...
        <div style="margin-top: 20px; border-top: 1px solid #ddd; padding-top: 10px;">
            ...
            <a href="{{ route('social.redirect', 'google') }}" class="social-btn google">Register with Google</a>
            <a href="{{ route('social.redirect', 'github') }}" class="social-btn github">Register with GitHub</a>
        </div>
    </div>
