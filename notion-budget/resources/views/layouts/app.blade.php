        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 d-md-block sidebar collapse offcanvas-md offcanvas-start" id="sidebarMenu">
                ...
                <div class="offcanvas-body d-flex flex-column p-3 pt-4 h-100">
                    <a href="{{ route('dashboard') }}" class="d-none d-md-block text-decoration-none fs-4 mb-4 fw-bold p-2" style="color: var(--primary);">
                        <i class="bi bi-layers-fill me-2"></i>{{ config('app.name') }}
                    </a>

                    <ul class="nav nav-pills flex-column mb-auto gap-1">
                        <li class="nav-item">
                            <a href="{{ route('dashboard') }}" class="nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }} rounded-3">
                                <i class="bi bi-grid-1x2 me-2"></i> Dashboard
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('workspace') }}" class="nav-link {{ request()->routeIs('workspace') ? 'active' : '' }} rounded-3">
