...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('can:roleView,project')->group(function () {
        ...
        // Edit Task
        Route::post('/project/{project}/task/edit', [ProjectController::class, 'EditTasks'])->name('project.task.edit');
...
Route::get('/test-sig', function () {
    $url = URL::signedRoute('test-sig-target');
    return "<a href='{$url}'>Click here to test the Proxy Signature</a>";
});
